...
$title_text_color_1 = 67;
$title_text_color_2 = 139;
$title_text_color_3 = 197;
...
/*
// Get JSON
$data = json_decode(file_get_contents('http://api.ustream.tv/json/channel/live/search/username:eq:' . $username));
...
*/
    ...
    // Channel data
    $data = json_decode(file_get_contents('https://gdata.youtube.com/feeds/api/users/' . $username));
